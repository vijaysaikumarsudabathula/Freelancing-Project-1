    ...
    <footer className="bg-white border-t-2 border-[#FAF9F6] pt-32 pb-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-12 border-l border-gray-50 pl-0 lg:pl-16">
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-4">
                {[t.shipping, t.privacy, t.terms, t.faq].map((link) => (
                  <li key={link}>
                    <button className="text-sm font-bold text-[#4A3728]/60 hover:text-[#2D5A27] transition-colors text-left">
                      {link}
                    </button>
                  </li>
                ))}
            ...
            <div className="space-y-8 md:col-span-1 col-span-2">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-sm font-bold text-[#2D5A27]/80 truncate">lathadairy@gmail.com</p>
                </div>
                <div className="flex flex-col gap-1">
